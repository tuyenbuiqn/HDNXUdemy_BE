...
namespace HDNXUdemyServices.Services
{
    public class MasterDataServices : IMasterDataServices
    {
        ...
        public async Task<bool> UpdateStatusCategory(Guid id, CategoryModel category)
        {
        ...
        public async Task<bool> UpdateInformationCategory(Guid id, CategoryModel category)
        {
            var getData = await _categoryRepository.GetByIdAsync(id) ?? new CategoryEntities();
            getData.Status = category.Status;
        ...
        public async Task<bool> UpdateStatusBanner(Guid id, BannerModel model)
        {
        ...
        public async Task<bool> UpdateInformationBanner(Guid id, BannerModel model)
        {
            var getData = await _bannerRepository.GetByIdAsync(id) ?? new BannerEntities();
            getData.Status = model.Status;
        ...
        public async Task<bool> UpdateStatusInformationManualBanking(Guid id, InformationManualBankingModel model)
        {
        ...
        public async Task<bool> UpdateInformationManualBanking(Guid id, InformationManualBankingModel model)
        {
            var getData = await _informationManualBankingRepository.GetByIdAsync(id) ?? new InformationManualBankingEntities();
            getData.Status = model.Status;
        ...
        public async Task<bool> UpdateStatusSubCategory(Guid id, SubCategoryModel model)
        {
        ...
        public async Task<bool> UpdateInformationSubCategory(Guid id, SubCategoryModel model)
        {
            var getData = await _subCategoryRepository.GetByIdAsync(id) ?? new SubCategoryEntities();
            getData.Status = model.Status;
        ...
        public async Task<SubCategoryModel> GetSubCategory(Guid id)
        {
        ...
        public async Task<bool> UpdateStatusConfigSystem(Guid id, SystemConfigModel model)
        {
        ...
        public async Task<bool> UpdateInformationConfigSystem(Guid id, SystemConfigModel model)
        {
            var getData = await _systemConfigRepository.GetByIdAsync(id) ?? new SystemConfigEntities();
            getData.Status = model.Status;
        ...
        public async Task<SystemConfigModel> GetConfigSystem(Guid id)
        {
