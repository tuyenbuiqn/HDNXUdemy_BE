...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240305171554_UpdateEditColumnPurchase")]
    partial class UpdateEditColumnPurchase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 3, 5, 17, 15, 54).PlusNanoseconds(271369400L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 3, 5, 17, 15, 54).PlusNanoseconds(271369400L)
                        },
                        new
                        {
                            Id = 2L,
