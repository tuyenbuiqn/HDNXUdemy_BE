...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240117092842_EditColumnForCourse")]
    partial class EditColumnForCourse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 17, 9, 28, 42).PlusNanoseconds(244352900L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 17, 9, 28, 42).PlusNanoseconds(244352900L)
                        },
                        new
                        {
                            Id = 2L,
