...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240116161632_EditValueColumn")]
    partial class EditValueColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 16, 16, 16, 32).PlusNanoseconds(663315300L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 16, 16, 16, 32).PlusNanoseconds(663315300L)
                        },
                        new
                        {
                            Id = 2L,
