...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240114045431_UpdateMoreColumnAndEditInfomation")]
    partial class UpdateMoreColumnAndEditInfomation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 14, 4, 54, 31).PlusNanoseconds(782134400L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 14, 4, 54, 31).PlusNanoseconds(782134400L)
                        },
                        new
                        {
                            Id = 2L,
