...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240122050447_AddEditNameOfColumnForUser")]
    partial class AddEditNameOfColumnForUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 22, 5, 4, 46).PlusNanoseconds(936209500L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 22, 5, 4, 46).PlusNanoseconds(936209500L)
                        },
                        new
                        {
                            Id = 2L,
