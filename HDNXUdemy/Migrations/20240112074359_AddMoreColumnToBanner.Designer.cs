...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240112074359_AddMoreColumnToBanner")]
    partial class AddMoreColumnToBanner
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 12, 7, 43, 59).PlusNanoseconds(597636800L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 12, 7, 43, 59).PlusNanoseconds(597636800L)
                        },
                        new
                        {
                            Id = 2L,
