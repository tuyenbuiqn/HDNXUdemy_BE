...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240113173241_AddValueNameOfColumnFile")]
    partial class AddValueNameOfColumnFile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 13, 17, 32, 41).PlusNanoseconds(805419400L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 13, 17, 32, 41).PlusNanoseconds(805419400L)
                        },
                        new
                        {
                            Id = 2L,
