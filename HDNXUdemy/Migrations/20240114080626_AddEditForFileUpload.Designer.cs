...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240114080626_AddEditForFileUpload")]
    partial class AddEditForFileUpload
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 14, 8, 6, 26).PlusNanoseconds(893699200L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 14, 8, 6, 26).PlusNanoseconds(893699200L)
                        },
                        new
                        {
                            Id = 2L,
