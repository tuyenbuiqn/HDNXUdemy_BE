...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240315182626_UpdateCodeForCreateNewTheadCommentForCourse")]
    partial class UpdateCodeForCreateNewTheadCommentForCourse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 3, 15, 18, 26, 26).PlusNanoseconds(524842500L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 3, 15, 18, 26, 26).PlusNanoseconds(524842500L)
                        },
                        new
                        {
                            Id = 2L,
