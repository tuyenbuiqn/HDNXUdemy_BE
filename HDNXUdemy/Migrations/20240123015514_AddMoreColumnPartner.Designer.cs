...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240123015514_AddMoreColumnPartner")]
    partial class AddMoreColumnPartner
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 23, 1, 55, 14).PlusNanoseconds(37874900L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 23, 1, 55, 14).PlusNanoseconds(37874900L)
                        },
                        new
                        {
                            Id = 2L,
