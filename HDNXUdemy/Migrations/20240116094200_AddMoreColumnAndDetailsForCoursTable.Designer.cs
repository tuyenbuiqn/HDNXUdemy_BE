...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240116094200_AddMoreColumnAndDetailsForCoursTable")]
    partial class AddMoreColumnAndDetailsForCoursTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 16, 9, 42, 0).PlusNanoseconds(690963400L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 16, 9, 42, 0).PlusNanoseconds(690963400L)
                        },
                        new
                        {
                            Id = 2L,
