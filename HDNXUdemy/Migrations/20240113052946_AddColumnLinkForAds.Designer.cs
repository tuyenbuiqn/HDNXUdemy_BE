...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240113052946_AddColumnLinkForAds")]
    partial class AddColumnLinkForAds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 13, 5, 29, 46).PlusNanoseconds(297497500L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 13, 5, 29, 46).PlusNanoseconds(297497500L)
                        },
                        new
                        {
                            Id = 2L,
