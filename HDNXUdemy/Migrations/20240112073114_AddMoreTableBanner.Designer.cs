...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240112073114_AddMoreTableBanner")]
    partial class AddMoreTableBanner
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 12, 7, 31, 14).PlusNanoseconds(480053200L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 12, 7, 31, 14).PlusNanoseconds(480053200L)
                        },
                        new
                        {
                            Id = 2L,
