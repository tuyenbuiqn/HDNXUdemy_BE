...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240116155908_AddMoreInfomationWithCourse")]
    partial class AddMoreInfomationWithCourse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 16, 15, 59, 8).PlusNanoseconds(260229800L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 16, 15, 59, 8).PlusNanoseconds(260229800L)
                        },
                        new
                        {
                            Id = 2L,
