...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240126164803_AddMoreColumnForInactiveUser")]
    partial class AddMoreColumnForInactiveUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 26, 16, 48, 3).PlusNanoseconds(314302600L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 26, 16, 48, 3).PlusNanoseconds(314302600L)
                        },
                        new
                        {
                            Id = 2L,
