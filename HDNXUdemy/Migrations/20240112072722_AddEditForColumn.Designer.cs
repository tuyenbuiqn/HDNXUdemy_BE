...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240112072722_AddEditForColumn")]
    partial class AddEditForColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 12, 7, 27, 21).PlusNanoseconds(961479400L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 12, 7, 27, 21).PlusNanoseconds(961479400L)
                        },
                        new
                        {
                            Id = 2L,
