...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240128043943_EditColumnNotification")]
    partial class EditColumnNotification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 28, 4, 39, 43).PlusNanoseconds(807884100L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 28, 4, 39, 43).PlusNanoseconds(807884100L)
                        },
                        new
                        {
                            Id = 2L,
