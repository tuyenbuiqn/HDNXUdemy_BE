...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240312073119_UpdateCodeForPurchaseOrder")]
    partial class UpdateCodeForPurchaseOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 3, 12, 7, 31, 19).PlusNanoseconds(145039400L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 3, 12, 7, 31, 19).PlusNanoseconds(145039400L)
                        },
                        new
                        {
                            Id = 2L,
