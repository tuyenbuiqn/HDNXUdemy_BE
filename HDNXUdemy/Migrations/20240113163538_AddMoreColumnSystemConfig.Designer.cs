...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240113163538_AddMoreColumnSystemConfig")]
    partial class AddMoreColumnSystemConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 13, 16, 35, 38).PlusNanoseconds(297055000L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 13, 16, 35, 38).PlusNanoseconds(297055000L)
                        },
                        new
                        {
                            Id = 2L,
