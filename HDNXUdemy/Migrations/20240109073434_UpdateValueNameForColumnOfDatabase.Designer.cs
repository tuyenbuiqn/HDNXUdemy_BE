...
namespace HDNXUdemyData.Migrations
{
    ...
    [Migration("20240109073434_UpdateValueNameForColumnOfDatabase")]
    partial class UpdateValueNameForColumnOfDatabase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HDNXUdemyData.Entities.CategoryEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreateBy = 1,
                            CreateDate = new NodaTime.LocalDateTime(2024, 1, 9, 7, 34, 34).PlusNanoseconds(289747600L),
                            Name = "Thiết kế cơ khí",
                            Status = 0,
                            UpdateBy = 1,
                            UpdateDate = new NodaTime.LocalDateTime(2024, 1, 9, 7, 34, 34).PlusNanoseconds(289747600L)
                        },
                        new
                        {
                            Id = 2L,
